    ...
    <section className="flex flex-col gap-4 mt-6">
      <div className="flex items-center justify-between pb-2 border-b border-[#2A2E39]">
        <h3 className="text-[14px] font-black uppercase tracking-widest text-[#D1D4DC] flex items-center gap-2">
          ...
          Bitcoin Market Cycles <span className="text-[10px] text-[#787B86] lowercase tracking-normal font-mono animate-pulse">(Live analysis)</span>
        </h3>
        <button className="text-[9px] font-bold uppercase tracking-widest bg-[#2A2E39] text-[#787B86] hover:text-[#B2B5BE] hover:bg-slate-200 px-3 py-1 rounded transition-colors">See More</button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-[#131722] shadow-sm border border-[#2A2E39] p-5 rounded-xl flex flex-col gap-4 relative overflow-hidden group hover:bg-[#1E222D] transition-colors">
          ...
          <div className="text-2xl font-mono font-bold text-[#D1D4DC]">{puell.toFixed(4)}</div>
        ...
        <div className="bg-[#131722] shadow-sm border border-[#2A2E39] p-5 rounded-xl flex flex-col gap-4 relative overflow-hidden group hover:bg-[#1E222D] transition-colors">
          ...
          <div className="flex justify-between items-center mt-1">
            <div className="flex flex-col gap-1">
              ...
              <span className="font-mono font-bold text-[#D1D4DC] transition-colors">${dma111.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0})}</span>
            </div>
            ...
            <div className="flex flex-col gap-1 text-right">
              ...
              <span className="font-mono font-bold text-[#D1D4DC] transition-colors">${dma350.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0})}</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#131722] shadow-sm border border-[#2A2E39] p-5 rounded-xl flex flex-col gap-4 relative overflow-hidden group hover:bg-[#1E222D] transition-colors">
          ...
          <div className="flex justify-between items-end">
             <div className="text-2xl font-mono font-bold text-[#D1D4DC]">{indicators.toFixed(1)}%</div>
