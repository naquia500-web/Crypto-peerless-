...
export const ASSETS: Asset[] = [
  { id: 'btc', name: 'Bitcoin', symbol: 'BTC', binanceSymbol: 'BTCUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/btc.svg', rank: 1 },
  { id: 'eth', name: 'Ethereum', symbol: 'ETH', binanceSymbol: 'ETHUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/eth.svg', rank: 2 },
  { id: 'bnb', name: 'BNB', symbol: 'BNB', binanceSymbol: 'BNBUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/bnb.svg', rank: 4 },
  { id: 'sol', name: 'Solana', symbol: 'SOL', binanceSymbol: 'SOLUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/sol.svg', rank: 5 },
  { id: 'xrp', name: 'XRP', symbol: 'XRP', binanceSymbol: 'XRPUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/xrp.svg', rank: 6 },
  { id: 'ada', name: 'Cardano', symbol: 'ADA', binanceSymbol: 'ADAUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/ada.svg', rank: 8 },
  { id: 'doge', name: 'Dogecoin', symbol: 'DOGE', binanceSymbol: 'DOGEUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/doge.svg', rank: 9 },
  { id: 'dot', name: 'Polkadot', symbol: 'DOT', binanceSymbol: 'DOTUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/dot.svg', rank: 11 },
  { id: 'matic', name: 'Polygon', symbol: 'MATIC', binanceSymbol: 'MATICUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/matic.svg', rank: 14 },
  { id: 'link', name: 'Chainlink', symbol: 'LINK', binanceSymbol: 'LINKUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/link.svg', rank: 15 },
  { id: 'avax', name: 'Avalanche', symbol: 'AVAX', binanceSymbol: 'AVAXUSDT', icon: 'https://cdn.jsdelivr.net/gh/atomiclabs/cryptocurrency-icons@1a63530be6e374711a8554f31b17e4cb92c25fa5/svg/color/avax.svg', rank: 12 },
];
...
export function AssetChart() {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(`https://api.binance.com/api/v3/klines?symbol=${activeAsset.binanceSymbol}&interval=${intervalStr}&limit=${limit}`)
      .then(res => res.json())
      .then((json: any[][]) => {
  ...
  const percentage = firstPrice > 0 ? (((currentPrice - firstPrice) / firstPrice) * 100).toFixed(2) : '0.00';
  ...
  return (
    <div className="bg-[#131722] text-white rounded-xl overflow-hidden font-sans shadow-sm w-full">
      <div className="p-6 md:p-8">
        ...
        <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
          <div className="flex flex-col gap-2 relative z-20">
            <div className="flex items-center gap-2">
              ...
              />
              <h1 className="text-2xl font-bold text-white">{activeAsset.name}</h1>
              <span className="text-[#787B86] font-bold text-sm">{activeAsset.symbol}</span>
            ...
            <div className="flex items-center gap-3 mt-1 relative z-30">
              ...
              <span className={`flex items-center text-sm font-bold ${isPositive ? 'text-green-600' : 'text-red-600'}`}>
                       ...
                       {filteredAssets.map(asset => (
                         ...
                         >
                           ...
                           <div className="flex flex-col">
                             ...
                             <span className="text-[#787B86] text-xs font-mono">{asset.symbol}</span>
                           </div>
                         </div>
                       ))}
                     </div>
        ...
        <div className="mt-8">
          <h2 className="text-lg font-bold text-[#D1D4DC] mb-4">{activeAsset.name} to USD Chart</h2>
              ...
              {(['24h', '1W', '1M', '1Y', 'All'] as const).map(tf => (
                <button
                  ...
                  className={`px-2 py-1 text-[13px] font-bold rounded-lg transition-colors ${
                    timeframe === tf ? 'bg-[#2A2E39] text-white' : 'text-[#787B86] hover:text-white'
                  }`}
                >
                  {tf}
                </button>
          ...
          {chartMode === 'TradingView' ? (
            ...
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={data} margin={{ top: 10, right: 0, left: 0, bottom: 0 }}>
                ...
                />
                <Tooltip
                  cursor={{ stroke: '#B2B5BE', strokeWidth: 1, strokeDasharray: '3 3' }}
                  contentStyle={{ backgroundColor: '#1E222D', border: '1px solid #363A45', borderRadius: '8px', boxShadow: '0 4px 6px -1px rgba(0, 0, 0, 0.4)' }}
                  itemStyle={{ color: '#fff', fontSize: '14px', fontWeight: 'bold' }}
                  labelStyle={{ color: '#787B86', marginBottom: '4px', fontSize: '12px' }}
                ...
                />
                <ReferenceLine y={firstPrice} stroke="#787B86" strokeDasharray="3 3" opacity={0.5} />
                <Area 
                  type="monotone" 
                  dataKey="price" 
                  stroke={themeColor}
                  ...
                  fillOpacity={1} 
                  fill="url(#colorPrice)" 
                  activeDot={{ r: 4, fill: '#131722', stroke: themeColor, strokeWidth: 2 }}
                />
              </AreaChart>
            </ResponsiveContainer>
          )}
        ...
        {/* Converter Section */}
        <div className="mb-10">
          <h3 className="text-sm font-bold text-[#D1D4DC] mb-4">BTC to USD converter</h3>
