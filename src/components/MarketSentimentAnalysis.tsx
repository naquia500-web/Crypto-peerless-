...
export function MarketSentimentAnalysis() {
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="bg-[#131722] shadow-lg border border-[#2A2E39] rounded-2xl overflow-hidden">
        <div className="p-6 border-b border-[#2A2E39] bg-[#1E222D]">
          ...
          {mockSentimentData.map((coin, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-5 hover:bg-[#1E222D] transition-colors flex flex-col md:flex-row md:items-center gap-6"
              >
                {/* Coin Info */}
