    ...
    <section className="flex flex-col gap-4">
      <div className="flex justify-between items-end border-b border-[#2A2E39] pb-2">
        <div className="flex items-center gap-3">
          <h3 className="text-[11px] font-black uppercase tracking-widest text-white">Bitcoin Whale Live Tracker</h3>
              ...
              {COINS.map((coin, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right">
                      {coinData ? (
                        <span className={`font-mono font-bold text-[12px] tracking-tight px-1.5 py-0.5 rounded bg-[#1E222D] ${isPositive ? 'accent-green' : 'accent-red'}`}>
