...
export function TreasuryHoldings() {
  const [holdings, setHoldings] = useState([
    { rank: 1, name: 'MicroStrategy', ticker: 'MSTR', country: 'US', holdings: 214246, value: '$16.4B', cost: '$35.1K', logo: 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://microstrategy.com&size=64' },
    { rank: 2, name: 'MARA Holdings, Inc.', ticker: 'MARA', country: 'US', holdings: 17314, value: '$1.32B', cost: '--', logo: 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://mara.com&size=64' },
    { rank: 3, name: 'Tesla, Inc.', ticker: 'TSLA', country: 'US', holdings: 9720, value: '$745M', cost: '$33.3K', logo: 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://tesla.com&size=64' },
    { rank: 4, name: 'Coinbase Global', ticker: 'COIN', country: 'US', holdings: 9000, value: '$690M', cost: '--', logo: 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://coinbase.com&size=64' },
    { rank: 5, name: 'Hut 8 Mining Corp', ticker: 'HUT', country: 'CA', holdings: 9113, value: '$698M', cost: '--', logo: 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://hut8.io&size=64' },
    { rank: 6, name: 'Block, Inc.', ticker: 'SQ', country: 'US', holdings: 8027, value: '$615M', cost: '$27.4K', logo: 'https://t3.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=http://block.xyz&size=64' },
  ]);
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setHoldings(prev => prev.map(h => {
        ...
        let formattedValue = '';
        if (newValue > 1e9) formattedValue = `$${(newValue / 1e9).toFixed(2)}B`;
