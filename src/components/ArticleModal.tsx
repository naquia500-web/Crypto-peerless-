    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        <motion.div
          ...
          className="relative w-full max-w-4xl max-h-[90vh] bg-[#131722] rounded-2xl border border-teal-500/30 shadow-[0_0_50px_rgba(45,212,191,0.1)] flex flex-col overflow-hidden"
        >
          {/* Header */}
          <div className="flex justify-between items-center p-6 border-b border-[#2A2E39] shrink-0">
            ...
            >
              <X className="w-5 h-5 text-[#787B86]" />
            </button>
          </div>
            ...
            {article && (
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="w-full lg:w-1/3 flex flex-col gap-4 shrink-0">
                  ...
                  <p className="text-sm text-[#787B86] leading-relaxed border-l-2 border-teal-500/30 pl-3">
                    {article.description}
                  </p>
                </div>
