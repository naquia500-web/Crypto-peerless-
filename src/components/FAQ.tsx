          ...
          return (
            ...
            >
              <button
                ...
                className="w-full py-5 flex items-center justify-between text-left group hover:bg-white/10 transition-colors px-4 -mx-4 rounded"
              >
                ...
                <div className="shrink-0 w-8 h-8 rounded-full border border-white/10 flex items-center justify-center bg-white/5 group-hover:border-orange-500/50 group-hover:bg-orange-500/10 transition-all text-white/60 group-hover:text-orange-500">
              ...
              <AnimatePresence>
                {isOpen && (
                  ...
                  >
                    <div className="pb-6 pt-2 pl-4 pr-12 text-sm text-white/50 leading-relaxed font-sans border-l-2 border-orange-500/50 ml-4 mb-4">
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
