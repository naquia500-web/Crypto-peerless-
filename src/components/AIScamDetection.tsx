...
export function AIScamDetection() {
  ...
  const initialTokens = [
    {
      name: "PepeDog (PEPEDOG)",
      risk: "Extreme",
      score: 12,
      reason: "Honeypot detected in contract",
    ...
    },
    {
      ...
      risk: "Safe",
      score: 98,
      reason: "Verified open source & high liquidity",
    ...
    },
    {
      ...
      risk: "High",
      score: 35,
      reason: "Developer wallet holds 80% supply",
    ...
    },
    {
      ...
      risk: "Safe",
      score: 92,
      reason: "Audited by top tier firm",
      icon: <ShieldCheck className="w-4 h-4 text-green-500" />,
    },
    {
      name: "SafeMoon V3",
      risk: "Medium",
      score: 55,
      reason: "High buy/sell tax detected",
    ...
    },
    {
      ...
      risk: "Safe",
      score: 99,
      reason: "Decentralized and highly secure",
      icon: <ShieldCheck className="w-4 h-4 text-green-500" />,
    },
    {
      name: "ElonMarsCoin",
      risk: "Extreme",
      score: 5,
      reason: "Mint function unprotected and hidden mints",
      icon: <AlertTriangle className="w-4 h-4 text-red-400" />,
    },
    {
      name: "Arbitrum (ARB)",
      risk: "Safe",
      score: 95,
      reason: "L2 contract audited by Offchain Labs",
      icon: <ShieldCheck className="w-4 h-4 text-green-500" />,
    },
  ];

  const [scannedTokens, setScannedTokens] = useState<any[]>(
    initialTokens.slice(0, 4),
  );
    ...
    <div className="bg-[#131722] rounded-xl p-6 border border-[#2A2E39] shadow-lg flex flex-col gap-6">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-xl font-bold text-white flex items-center gap-2">
            <Cpu className="w-5 h-5 text-purple-500" /> AI Scam &amp; Risk
            Detection
          </h3>
          <p className="text-sm text-gray-400 mt-1">
            Smart contract analysis &amp; liquidity monitoring
          </p>
        </div>
      ...
      <div className="flex-1 flex flex-col gap-4 overflow-y-auto pr-2 no-scrollbar">
        {scannedTokens.map((token, i) => (
          <div
            key={i}
            className="flex items-center justify-between p-4 bg-[#1E222D] rounded-lg border border-[#2A2E39] hover:border-purple-500/30 transition-colors"
          >
      ...
      <form
        onSubmit={handleScan}
        className="mt-2 text-sm font-bold transition-colors w-full"
      >
