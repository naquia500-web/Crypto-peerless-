    ...
    <section className="flex flex-col gap-6 mt-8">
      <div className="flex items-center justify-between pb-2 border-b border-white/10">
        ...
        <button 
          ...
          className="text-[9px] font-bold uppercase tracking-widest bg-white/5 text-orange-400 border border-orange-500/30 px-3 py-1 rounded-full flex items-center gap-1.5 transition-colors hover:bg-orange-500/10 cursor-pointer"
        >
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="text-sm text-white/50 leading-relaxed font-sans flex flex-col gap-3">
          <p>
      ...
      <div className="mt-4 flex flex-col gap-5 border-t border-white/10 pt-6">
