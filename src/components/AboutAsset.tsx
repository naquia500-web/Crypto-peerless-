    ...
    <section className="flex flex-col gap-6 mt-8">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="text-sm text-[#787B86] leading-relaxed font-sans flex flex-col gap-3">
          <p>
            <strong className="text-white">Bitcoin</strong> is a decentralized
            cryptocurrency originally described in a 2008 whitepaper by a
            person, or group of people, using the alias Satoshi Nakamoto. It was
          ...
          <p>
            ...
            words, to allow "online payments to be sent directly from one party
      ...
      <div className="mt-4 flex flex-col gap-5 border-t border-[#2A2E39] pt-6">
        ...
        <p className="text-sm text-[#787B86] leading-relaxed font-sans">
          The live <strong className="text-white">Bitcoin price today</strong>{" "}
          is $76,685.27 USD with a 24-hour trading volume of $38,290,133,383
          USD. We update our BTC to USD price in real-time. Bitcoin is up 1.97%
          in the last 24 hours. The current CoinMarketCap ranking is #1, with a
          live market cap of $1,535,150,327,473 USD. It has a circulating supply
          of 20,018,843 BTC coins and a max. supply of 21,000,000 BTC coins.
        </p>
      </div>
    </section>
  );
